 ...
 */
final class Version20191110204605 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, discussion_id INT DEFAULT NULL, commentaire_id INT DEFAULT NULL, auteur_id INT NOT NULL, INDEX IDX_AC6340B31ADED311 (discussion_id), INDEX IDX_AC6340B360BB6FE6 (auteur_id), INDEX IDX_AC6340B3A76ED395 (user_id), INDEX IDX_AC6340B3BA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
